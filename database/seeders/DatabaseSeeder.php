...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $letterTypes = [
            ['code' => 'ST', 'name' => 'Surat Tugas', 'description' => 'Surat tugas untuk kegiatan tertentu'],
            ['code' => 'SK', 'name' => 'Surat Keterangan', 'description' => 'Surat keterangan berbagai keperluan'],
            ['code' => 'SP', 'name' => 'Surat Pengantar', 'description' => 'Surat pengantar untuk instansi lain'],
            ['code' => 'SR', 'name' => 'Surat Rekomendasi', 'description' => 'Surat rekomendasi'],
            ['code' => 'SU', 'name' => 'Surat Undangan', 'description' => 'Surat undangan resmi'],
        ];
