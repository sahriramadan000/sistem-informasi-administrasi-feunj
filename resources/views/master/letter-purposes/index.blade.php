...
@section('content')
    ...
    {{-- Search Section --}}
    <div class="mb-6">
        <form method="GET" action="{{ route('master.letter-purposes.index') }}">
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}"
                    ...
                    placeholder="Cari berdasarkan nama atau deskripsi keperluan surat...">
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <h3 class="text-base font-semibold text-gray-900">Daftar Tujuan Surat</h3>
                    @if(request('search'))
                ...
                <div class="flex items-center gap-2">
                    ...
                    <form method="GET" action="{{ route('master.letter-purposes.index') }}" class="inline-block m-0">
                        @if (request('search'))
        ...
        <div class="overflow-x-auto">
            @if($letterPurposes->count() > 0)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form method="POST" 
                                          ...
                                          onsubmit="return confirm('Apakah Anda yakin ingin menonaktifkan keperluan ini? Data tidak akan dihapus dari database.')"
                                          class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                ...
                {{-- Pagination --}}
                <div class="px-6 py-4">
                    {{ $letterPurposes->appends(request()->query())->links() }}
                </div>
            @else
