...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Buat klasifikasi baru untuk penomoran surat</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        <div class="p-6">
            <form method="POST" action="{{ route('master.classification-letters.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Masukkan deskripsi klasifikasi">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-sm text-destructive flex items-center gap-1.5">
                                <i data-lucide="alert-circle" class="w-4 h-4"></i>
                                {{ $message }}
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-muted-foreground">Centang jika klasifikasi ini dapat digunakan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <div class="bg-orange-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <ul class="list-disc list-inside text-sm text-brand-darker space-y-1">
                                ...
                                <li>Pastikan kode bersifat unik dan mudah dikenali</li>
                                <li>Klasifikasi yang aktif akan muncul di dropdown saat membuat surat</li>
                            </ul>
                        </div>
                    </div>
                </div>
