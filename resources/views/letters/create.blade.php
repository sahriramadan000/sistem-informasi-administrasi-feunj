...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Isi formulir di bawah untuk membuat surat baru dan generate nomor otomatis</p>
        </div>
        <a href="{{ route('letters.index') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-0 md:pl-13">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="letter_type_id" 
                                    name="letter_type_id" 
                                    class="select @error('letter_type_id') !border-red-500 @enderror" 
                                    required>
                                <option value="">-- Pilih Jenis Surat --</option>
                                @foreach($letterTypes as $letterType)
                                    <option value="{{ $letterType->id }}" {{ old('letter_type_id') == $letterType->id ? 'selected' : '' }}>
                                        {{ $letterType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="classification_id" 
                                    ...
                                    class="select @error('classification_id') !border-red-500 @enderror" 
                                    required>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pl-0 md:pl-13">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="signatory_id" 
                                    name="signatory_id" 
                                    class="select @error('signatory_id') !border-red-500 @enderror" 
                                    required>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <div class="flex items-start gap-4">
                                <input type="number" 
                                       ...
                                       min="1"
                                       max="50"
                                       class="input max-w-xs @error('quantity') !border-red-500 @enderror" 
                                       placeholder="1">
                                <div class="flex-1">
                            ...
                            <div id="letter_purpose_field" class="space-y-2" style="display: none;">
                                ...
                                <select id="letter_purpose_id" 
                                    ...
                                    @foreach($letterPurposes as $purpose)
                                        <option value="{{ $purpose->id }}" {{ old('letter_purpose_id') == $purpose->id ? 'selected' : '' }}>
                                            {{ $purpose->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-gray-700 space-y-1">
                                    ...
                                    <li class="flex items-start gap-2">
                                        <i data-lucide="check" class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0"></i>
                                        <span>Format nomor: <strong>[000]/[kode_penandatangan].[kode_klasifikasi]/[tahun]</strong></span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <i data-lucide="check" class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0"></i>
